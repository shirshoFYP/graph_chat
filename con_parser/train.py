...
from utils import get_device, load_model, count_params, count_actions, conf_to_dict
from loss import action_loss, action_seq_loss
...
def train(
    ...
    while True:
        ...
        if cfg.decoder == "graph":
            ...
            loss = action_seq_loss(logits, all_gt_actions, label_vocab, cfg.batch_size)
